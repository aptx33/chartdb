        ...
        return (
            <TableNodeContextMenu table={table}>
                ...
                >
                    ...
                    ></div>
                    <div className="group flex min-h-9 items-start justify-between bg-slate-200 px-2 py-1 dark:bg-slate-900">
                        <div className="flex min-w-0 flex-1 items-start gap-2">
                            ...
                            <div className="flex min-w-0 flex-1 flex-col">
                                {tableChangedName ? (
                                    <Label className="flex h-5 max-w-full items-center justify-center truncate rounded-sm bg-sky-200 px-2 py-0.5 text-sm font-normal text-sky-900 dark:bg-sky-800 dark:text-sky-200">
                                    ...
                                    <Label className="flex h-5 max-w-full flex-col justify-center truncate rounded-sm bg-green-200 px-2 py-0.5 text-sm font-normal text-green-900 dark:bg-green-800 dark:text-green-200">
                                        {table.name}
                                    </Label>
                                ) : isDiffTableRemoved ? (
                                    <Label className="flex h-5 max-w-full flex-col justify-center truncate rounded-sm bg-red-200 px-2 py-0.5 text-sm font-normal text-red-900 dark:bg-red-800 dark:text-red-200">
                                        {table.name}
                                    </Label>
                                ) : isDiffTableChanged && !isSummaryOnly ? (
                                    <Label className="flex h-5 max-w-full flex-col justify-center truncate rounded-sm bg-sky-200 px-2 py-0.5 text-sm font-normal text-sky-900 dark:bg-sky-800 dark:text-sky-200">
                                        {table.name}
                                    </Label>
                                ) : (
                                    <Label className="block max-w-full truncate px-2 py-0.5 text-sm font-bold">
                                        {table.name}
                                    </Label>
                                )}
                                {table.comments ? (
                        ...
                        <div className="hidden shrink-0 flex-row pt-0.5 group-hover:flex">
                            {readonly ? null : (
                                <Button
                                    variant="ghost"
                    ...
                    <div
                        ...
                        style={{
                            maxHeight: expanded
                                ? `${(editTableMode && editModeInitialFieldCount !== null ? fields.slice(0, editModeInitialFieldCount) : fields).reduce((sum, f) => sum + FIELD_HEIGHT + (f.comments ? FIELD_COMMENT_EXTRA_HEIGHT : 0), 0)}px`
                                : `${visibleFields.reduce((sum, f) => sum + FIELD_HEIGHT + (f.comments ? FIELD_COMMENT_EXTRA_HEIGHT : 0), 0)}px`,
                        }}
                    >
